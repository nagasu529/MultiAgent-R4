    ...
    protected void setup(){
        ...
        addBehaviour(new TickerBehaviour(this, 15000){
            protected void onTick() {
                myGui.displayUI("Name: " + bidderInfo.farmerName + "\n");
                myGui.displayUI("Status: " + bidderInfo.agentType + "\n");
                myGui.displayUI("Volumn to sell: " + bidderInfo.buyingVolume + "\n");
                myGui.displayUI("Selling price: " + bidderInfo.buyingPrice + "\n");
                myGui.displayUI("\n");
