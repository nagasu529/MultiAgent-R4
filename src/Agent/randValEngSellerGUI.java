...
public class randValEngSellerGUI extends JFrame {
    //Farming agent class
    private randValEngSeller myAgent;
    ...
    randValEngSellerGUI(randValEngSeller a) {
        super(a.getLocalName() + " Result Monitoring");
        myAgent = a;
